<?php
/**
 * This file contains the File cache class used in the MailLauncherApi PHP-SDK.
 *
...
/**
 * MailLauncherApi_Cache_File makes use of the file system in order to cache data.
 *
 * @author Serban George Cristian <support@maillauncher.com>
 ...
 * @since 1.0
 */
class MailLauncherApi_Cache_File extends MailLauncherApi_Cache_Abstract
{
    /**
     ...
     * @return MailLauncherApi_Cache_File
     */
