<?php
/**
 * This file contains the base class for the MailLauncherApi PHP-SDK.
 *
...
/**
 * MailLauncherApi_Base is the base class for all the other classes used in the sdk.
 *
 * @author Serban George Cristian <support@maillauncher.com>
 * @package MailLauncherApi
 * @since 1.0
 */
class MailLauncherApi_Base
{
    /**
    ...
    /**
     * @var MailLauncherApi_Config the configuration object injected into the application at runtime
     */
    private static $_config;
    
    /**
     * @var MailLauncherApi_Params the package registry that will hold various components
     */
    private static $_registry;
    
    /**
     * @var MailLauncherApi_Params the registered event handlers
     */
     ...
     *
     * @param MailLauncherApi_Config $config
     * @return void
     */
    public static function setConfig(MailLauncherApi_Config $config)
    {
        self::$_config = $config;
    }
     ...
     *
     * @return MailLauncherApi_Params
     * @throws Exception
     */
    public function getRegistry()
    {
        if (!(self::$_registry instanceof MailLauncherApi_Params)) {
            self::$_registry = new MailLauncherApi_Params(is_array(self::$_registry) ? self::$_registry : array());
        }
     ...
     * $components = array(
     *     'cache'=>array(
     *         'class'             => 'MailLauncherApi_Cache_Sqlite',
    ...
    public function setComponent($componentName, array $config)
    {
        ...
        if ($component instanceof MailLauncherApi_Base) {
    ...
    {
        if (!(self::$_eventHandlers instanceof MailLauncherApi_Params)) {
            self::$_eventHandlers = new MailLauncherApi_Params(self::$_eventHandlers);
        }
        
        if (!self::$_eventHandlers->contains($eventName) || !(self::$_eventHandlers->itemAt($eventName) instanceof MailLauncherApi_Params)) {
            self::$_eventHandlers->add($eventName, new MailLauncherApi_Params());
        }
