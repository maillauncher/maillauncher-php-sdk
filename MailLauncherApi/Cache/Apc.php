...
/**
 * MailLauncherApi_Cache_Apc makes use of the APC extension in order to cache data in memory.
 *
 ...
 * @since 1.0
 */
class MailLauncherApi_Cache_Apc extends MailLauncherApi_Cache_Abstract
{
    /**
