...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    $endpoint   = new MailLauncherApi_Endpoint_ListSubscribers();
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://www.maillauncher.com/backend/assets/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="https://www.maillauncher.com/backend/assets/css/bootstrap-glyphicons.css" />
    <link rel="stylesheet" type="text/css" href="https://www.maillauncher.com/backend/assets/css/style.css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="https://www.maillauncher.com/backend/assets/js/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="https://www.maillauncher.com/favicon.ico" type="image/x-icon" /> 
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by MailLauncher EMS.
