<?php
/**
 * This file contains the APC cache class used in the MailLauncherApi PHP-SDK.
 *
...
/**
 * MailLauncherApi_Cache_Xcache makes use of the xcache extension in order to cache data in memory.
 *
 ...
 * @since 1.0
 */
class MailLauncherApi_Cache_Xcache extends MailLauncherApi_Cache_Abstract
{
    /**
