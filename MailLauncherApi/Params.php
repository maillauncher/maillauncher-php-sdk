 ...
 * @property MailLauncherApi_ParamsIterator $iterator An iterator for traversing the items in the list.
 ...
 */
 ...
 /**
 * MailLauncherApi_Params implements a collection that takes key-value pairs.
 *
 * You can access, add or remove an item with a key by using
 * {@link itemAt}, {@link add}, and {@link remove}.
 * To get the number of the items in the map, use {@link getCount}.
 * MailLauncherApi_Params can also be used like a regular array as follows,
 * <pre>
 * $map[$key]=$value; // add a key-value pair
 * unset($map[$key]); // remove the value with the specified key
 * if(isset($map[$key])) // if the map contains the key
 ...
 * @link http://www.maillauncher.com
 * @copyright 2020 https://www.maillauncher.com/
 ...
 */
class MailLauncherApi_Params extends MailLauncherApi_Base implements IteratorAggregate, ArrayAccess, Countable
{
    /**
     ...
     * @return MailLauncherApi_ParamsIterator an iterator for traversing the items in the list.
     */
    public function getIterator()
    {
        return new MailLauncherApi_ParamsIterator($this->_data);
    }
    ...
    public function copyFrom($data)
    {
        if (is_array($data) || $data instanceof Traversable) {
            ...
            if ($data instanceof MailLauncherApi_Params) {
                $data = $data->_data;
            }
