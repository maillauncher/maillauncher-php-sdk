<?php
/**
 * This file contains the configuration class for the MailLauncherApi PHP-SDK.
 *
...
/**
 * MailLauncherApi_Config contains the configuration class that is injected at runtime into the main application.
 *
 ...
 * @since 1.0
 */
class MailLauncherApi_Config extends MailLauncherApi_Base
{
    /**
