<?php
/**
 * This file contains the MailLauncherApi_Http_Client class used in the MailLauncherApi PHP-SDK.
 *
...
/**
 * MailLauncherApi_Http_Client is the http client interface used to make the remote requests and receive the responses.
 *
 * @author Serban George Cristian <support@maillauncher.com>
 ...
 * @since 1.0
 */
class MailLauncherApi_Http_Client extends MailLauncherApi_Base
{
    /**
    ...
    /**
     * @var MailLauncherApi_Params the GET params sent in the request.
     */
    public $paramsGet;
    
    /**
     * @var MailLauncherApi_Params the POST params sent in the request.
     */
    public $paramsPost;
    
    /**
     * @var MailLauncherApi_Params the PUT params sent in the request.
     */
    public $paramsPut;
    
    /**
     * @var MailLauncherApi_Params the DELETE params sent in the request.
     */
    public $paramsDelete;
    
    /**
     * @var MailLauncherApi_Params the headers sent in the request.
     */
    public $headers;
    ...
    public function __construct(array $options = array())
    {
        ...
        foreach (array('paramsGet', 'paramsPost', 'paramsPut', 'paramsDelete', 'headers') as $param) {
            if (!($this->$param instanceof MailLauncherApi_Params)) {
                $this->$param = new MailLauncherApi_Params(!is_array($this->$param) ? array() : $this->$param);
            }
        }
    }
    ...
    {
        $request = new MailLauncherApi_Http_Request($this);
