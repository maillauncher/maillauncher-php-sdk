<?php
/**
 * This file contains the MailLauncherApi_Http_Response class used in the MailLauncherApi PHP-SDK.
 *
...
/**
 * MailLauncherApi_Http_Response is the class used to get the responses back from the API endpoints.
 *
 * @author Serban George Cristian <support@maillauncher.com>
 ...
 * @since 1.0
 */
class MailLauncherApi_Http_Response extends MailLauncherApi_Base
{
    /**
    ...
    /**
     * @var MailLauncherApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var MailLauncherApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var MailLauncherApi_Params $body the body of the response.
     */
    public $body;
    ...
    /**
     * @var MailLauncherApi_Http_Request
     */
    public $request;
     ...
     * Contructor.
     *
     * @param MailLauncherApi_Http_Request $request
     *
     * @throws ReflectionException
     */
    public function __construct(MailLauncherApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new MailLauncherApi_Params($params);
        }
