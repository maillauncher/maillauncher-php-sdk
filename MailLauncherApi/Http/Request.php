<?php
/**
 * This file contains the MailLauncherApi_Http_Request class used in the MailLauncherApi PHP-SDK.
 *
...
/**
 * MailLauncherApi_Http_Request is the request class used to send the requests to the API endpoints.
 *
 * @author Serban George Cristian <support@maillauncher.com>
 ...
 * @since 1.0
 */
class MailLauncherApi_Http_Request extends MailLauncherApi_Base
{
    /**
     * @var MailLauncherApi_Http_Client the http client injected.
     */
    public $client;

    /**
     * @var MailLauncherApi_Params the request params.
     */
    public $params;
     ...
     * Constructor.
     *
     * @param MailLauncherApi_Http_Client $client
     */
    public function __construct(MailLauncherApi_Http_Client $client)
    {
        $this->client = $client;
    }
    ...
    public function send()
    {
        ...
        /** @var MailLauncherApi_Cache_Abstract $cacheComponent */
        $cacheComponent = null;
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'MailLauncherApi Client version '. MailLauncherApi_Http_Client::CLIENT_VERSION);
        ...
        if ($client->getIsPostMethod() || $client->getIsPutMethod() || $client->getIsDeleteMethod()) {
            $params = new MailLauncherApi_Params($client->paramsPost);
        ...
        $params = $this->params = new MailLauncherApi_Params($curlInfo);
        ...
        if ($curlCode === 0 && $client->getResponseHeaders) {
            ...
            $params->add('headers', new MailLauncherApi_Params($headers));
        }
        ...
        $params->add('body', new MailLauncherApi_Params($decodedBody));

        $response = new MailLauncherApi_Http_Response($this);
        $body = $response->body;
    ...
    protected function sign($requestUrl)
    {
        ...
        $params = new MailLauncherApi_Params($specialHeaderParams);
